-- Complete Database Setup for Tournament CRUD Application
-- Compatible with FreeSQL (sql12.freesqldatabase.com)
...
-- 4. VERIFY TABLES
-- ============================================
-- You can run these queries to verify the tables were created:
-- SHOW TABLES;
-- DESCRIBE users;
-- DESCRIBE tournament_signups;
